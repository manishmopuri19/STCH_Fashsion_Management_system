...
- [SQLAlchemy](https://www.sqlalchemy.org/) — ORM (SQLite by default, swappable via `DATABASE_URL`)
...
- [React Router](https://reactrouter.com/) — routing with role-protected routes
- [React Hook Form](https://react-hook-form.com/) + [Zod](https://zod.dev/) — form handling and validation
- [Tailwind CSS](https://tailwindcss.com/) — styling
- [Axios](https://axios-http.com/) — API client with auth interceptors
